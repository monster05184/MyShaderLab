...
public class FFTOcean : MonoBehaviour
{
    ...
    [Header("Absorption And Scattering")] 
    //光线吸收的控制
    [HideInInspector]public Gradient absorption;
    [HideInInspector]public Gradient scattering;
    ...
    private int kernelFoamGen;                          //生成浮沫贴图
    ...
    private RenderTexture FoamGenRT;                    //浮沫混合RT
    ...
    private void InitializeCSvalue()
    {
        ...
        kernelFoamGen = OceanCS.FindKernel("FoamGen");
    ...
    private void ComputeOceanValue()
    {
        ...
        //生成整体的浮沫
        OceanCS.SetTexture(kernelFoamGen, "FoamGenRT", FoamGenRT);
        OceanCS.SetTexture(kernelFoamGen, "BubblesRT", BubblesRT);
        OceanCS.SetFloat("FadeRate",0.01f);
        OceanCS.Dispatch(kernelFoamGen,fftSize / 8, fftSize / 8, 1);
